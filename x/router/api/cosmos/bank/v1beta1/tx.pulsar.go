...
import (
	_ "cosmossdk.io/x/router/api/amino"
	v1beta1 "cosmossdk.io/x/router/api/cosmos/base/v1beta1"
	_ "cosmossdk.io/x/router/api/cosmos/msg/v1"
	fmt "fmt"
...
var (
	...
	fd_MsgSend_memo         protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgSend_memo = md_MsgSend.Fields().ByName("memo")
}
...
func (x *fastReflection_MsgSend) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.bank.v1beta1.MsgSend.memo":
		return x.Memo != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgSend) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.bank.v1beta1.MsgSend.memo":
		panic(fmt.Errorf("field memo of message cosmos.bank.v1beta1.MsgSend is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.bank.v1beta1.MsgSend"))
		}
...
var file_cosmos_bank_v1beta1_tx_proto_rawDesc = []byte{
	...
	0x22, 0xc0, 0x02, 0x0a, 0x07, 0x4d, 0x73, 0x67, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x3b, 0x0a, 0x0c,
	...
	0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a,
	0x04, 0x6d, 0x65, 0x6d, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6d, 0x65, 0x6d,
	0x6f, 0x3a, 0x30, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x82, 0xe7, 0xb0, 0x2a, 0x0c,
	...
	0x1a, 0x05, 0x80, 0xe7, 0xb0, 0x2a, 0x01, 0x42, 0xcb, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x6e, 0x6b, 0x2e, 0x76, 0x31, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x42, 0x07, 0x54, 0x78, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x39,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73, 0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x78, 0x2f, 0x72,
	0x6f, 0x75, 0x74, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
