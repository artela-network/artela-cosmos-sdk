...
import (
	v1beta12 "cosmossdk.io/x/router/api/cosmos/base/v1beta1"
	v1beta11 "cosmossdk.io/x/router/api/cosmos/crypto/multisig/v1beta1"
	v1beta1 "cosmossdk.io/x/router/api/cosmos/tx/signing/v1beta1"
	fmt "fmt"
...
var file_cosmos_tx_v1beta1_tx_proto_rawDesc = []byte{
	...
	0xbd, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74,
