...
func (k BaseKeeper) GetPaginatedTotalSupply(ctx sdk.Context, pagination *query.PageRequest) (sdk.Coins, *query.PageResponse, error) {
	kvs, pageRes, err := query.CollectionPaginate[string, sdk.Int](ctx, k.Supply, pagination)
	if err != nil {
		return nil, nil, err
	}
	coins := sdk.NewCoins()
...
func (k BaseKeeper) GetDenomMetaData(ctx sdk.Context, denom string) (types.Metadata, bool) {
	m, err := k.BaseSendKeeper.DenomMetadata.Get(ctx, denom)
	return m, err == nil
}
...
func (k BaseKeeper) HasDenomMetaData(ctx sdk.Context, denom string) bool {
	has, err := k.BaseSendKeeper.DenomMetadata.Has(ctx, denom)
	return has && err == nil
}
...
func (k BaseKeeper) IterateAllDenomMetaData(ctx sdk.Context, cb func(types.Metadata) bool) {
	_ = sdk.IterateAndCallBack(ctx, k.BaseSendKeeper.DenomMetadata, func(_ string, value types.Metadata) bool {
		return cb(value)
	})
}
...
func (k BaseKeeper) SetDenomMetaData(ctx sdk.Context, denomMetaData types.Metadata) {
	_ = k.BaseSendKeeper.DenomMetadata.Set(ctx, denomMetaData.Base, denomMetaData)
}
...
func (k BaseViewKeeper) IterateTotalSupply(ctx sdk.Context, cb func(sdk.Coin) bool) {
	_ = sdk.IterateAndCallBack(ctx, k.Supply, func(key string, value sdk.Int) bool {
